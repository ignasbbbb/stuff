...
rs.Heartbeat:Connect(function()
	...
	if hum.MoveDirection.Magnitude == 0 then
		...
		RightHip.C0 = RightHip.C0:Lerp(cf(1, -1 + 0.2 * sin((sine + 1.5) * 6)*5, -0.25 + 0.25 * sin((sine + 1.5) * 6)*5) * angles(-0.7853981633974483 * sin((sine + 1.65) * 6)*5, 1.5707963267948966, 0), deltaTime) 
